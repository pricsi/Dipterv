...
public class TTMCHybridLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TTMCHybridLanguageGrammarAccess grammarAccess;
	...
	protected AbstractElementAlias match_HybridAutomatonDeclaration___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q;
	protected AbstractElementAlias match_HybridSpecification___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q;
	protected AbstractElementAlias match_Location___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_2__q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TTMCHybridLanguageGrammarAccess) access;
		...
		match_HybridAutomatonDeclaration___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getHybridAutomatonDeclarationAccess().getLeftParenthesisKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getHybridAutomatonDeclarationAccess().getRightParenthesisKeyword_2_2()));
		match_HybridSpecification___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getHybridSpecificationAccess().getLeftParenthesisKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getHybridSpecificationAccess().getRightParenthesisKeyword_2_2()));
		match_Location___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getLocationAccess().getLeftCurlyBracketKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getLocationAccess().getRightCurlyBracketKeyword_2_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_HybridAutomatonDeclaration___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q.equals(syntax))
				emit_HybridAutomatonDeclaration___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_HybridSpecification___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q.equals(syntax))
				emit_HybridSpecification___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Location___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_2__q.equals(syntax))
				emit_Location___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID (ambiguity) ':=' hybridAutomaton=HybridAutomaton
	 */
	protected void emit_HybridAutomatonDeclaration___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     name=ID (ambiguity) '{' constantDeclarations+=ConstantDeclaration
	 *     name=ID (ambiguity) '{' functionDeclarations+=FunctionDeclaration
	 *     name=ID (ambiguity) '{' hybridAutomatonDeclarations+=HybridAutomatonDeclaration
	 *     name=ID (ambiguity) '{' propertyDeclarations+=PropertyDeclaration
	 *     name=ID (ambiguity) '{' typeDeclarations+=TypeDeclaration
	 */
	protected void emit_HybridSpecification___LeftParenthesisKeyword_2_0_RightParenthesisKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     name=ID (ambiguity) (rule end)
	 */
	protected void emit_Location___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     (rule start) (ambiguity) '@' location=[Location|ID]
	 ...
	 *     (rule start) (ambiguity) 'd' operand=SignumExpression
