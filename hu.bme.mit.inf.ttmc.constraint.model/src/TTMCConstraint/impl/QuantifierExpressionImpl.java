 ...
 * </p>
 * <ul>
 *   <li>{@link TTMCConstraint.impl.QuantifierExpressionImpl#getParameterDeclarations <em>Parameter Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class QuantifierExpressionImpl extends UnaryExpressionImpl implements QuantifierExpression {
	/**
	...
	protected EClass eStaticClass() {
		return TTMCConstraintPackage.Literals.QUANTIFIER_EXPRESSION;
	}
	...
	public EList<ParameterDeclaration> getParameterDeclarations() {
		if (parameterDeclarations == null) {
			parameterDeclarations = new EObjectContainmentEList<ParameterDeclaration>(ParameterDeclaration.class, this, TTMCConstraintPackage.QUANTIFIER_EXPRESSION__PARAMETER_DECLARATIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TTMCConstraintPackage.QUANTIFIER_EXPRESSION__PARAMETER_DECLARATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ParametricElement.class) {
			switch (derivedFeatureID) {
				case TTMCConstraintPackage.QUANTIFIER_EXPRESSION__PARAMETER_DECLARATIONS: return TTMCConstraintPackage.PARAMETRIC_ELEMENT__PARAMETER_DECLARATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ParametricElement.class) {
			switch (baseFeatureID) {
				case TTMCConstraintPackage.PARAMETRIC_ELEMENT__PARAMETER_DECLARATIONS: return TTMCConstraintPackage.QUANTIFIER_EXPRESSION__PARAMETER_DECLARATIONS;
				default: return -1;
			}
		}
