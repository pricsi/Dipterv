 ...
 * </p>
 * <ul>
 *   <li>{@link TTMCConstraint.impl.AndExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndExpressionImpl extends BooleanExpressionImpl implements AndExpression {
	...
	protected EClass eStaticClass() {
		return TTMCConstraintPackage.Literals.AND_EXPRESSION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, TTMCConstraintPackage.AND_EXPRESSION__OPERANDS);
		}
		return operands;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MultiaryExpression.class) {
			switch (derivedFeatureID) {
				case TTMCConstraintPackage.AND_EXPRESSION__OPERANDS: return TTMCConstraintPackage.MULTIARY_EXPRESSION__OPERANDS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MultiaryExpression.class) {
			switch (baseFeatureID) {
				case TTMCConstraintPackage.MULTIARY_EXPRESSION__OPERANDS: return TTMCConstraintPackage.AND_EXPRESSION__OPERANDS;
				default: return -1;
			}
		}
