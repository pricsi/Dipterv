 ...
 * </p>
 * <ul>
 *   <li>{@link TTMCConstraint.impl.TupleTypeDefinitionImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeDefinitionImpl extends TypeDefinitionImpl implements TupleTypeDefinition {
	...
	protected EClass eStaticClass() {
		return TTMCConstraintPackage.Literals.TUPLE_TYPE_DEFINITION;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, TTMCConstraintPackage.TUPLE_TYPE_DEFINITION__TYPES);
		}
		return types;
	}
