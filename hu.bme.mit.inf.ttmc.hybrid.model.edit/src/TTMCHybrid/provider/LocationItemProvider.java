...
/**
 * This is the item provider adapter for a {@link TTMCHybrid.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TTMCHybridPackage.Literals.LOCATION__CONDITIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Location.class)) {
			case TTMCHybridPackage.LOCATION__CONDITIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TTMCHybridPackage.Literals.LOCATION__CONDITIONS,
				 TTMCHybridFactory.eINSTANCE.createInitialCondition()));

		newChildDescriptors.add
			(createChildParameter
				(TTMCHybridPackage.Literals.LOCATION__CONDITIONS,
				 TTMCHybridFactory.eINSTANCE.createInvariantCondition()));

		newChildDescriptors.add
			(createChildParameter
				(TTMCHybridPackage.Literals.LOCATION__CONDITIONS,
				 TTMCHybridFactory.eINSTANCE.createFlowCondition()));
	}
