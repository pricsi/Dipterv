...
/**
 * This is the item provider adapter for a {@link TTMCHybrid.PropertyDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyDeclarationItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PropertyDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TTMCHybridPackage.Literals.PROPERTY_DECLARATION__HYBRID_AUTOMATON);
			childrenFeatures.add(TTMCHybridPackage.Literals.PROPERTY_DECLARATION__EXPRESSION);
		}
	...
	/**
	 * This returns PropertyDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PropertyDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((PropertyDeclaration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PropertyDeclaration_type") :
			getString("_UI_PropertyDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PropertyDeclaration.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TTMCHybridPackage.Literals.PROPERTY_DECLARATION__HYBRID_AUTOMATON,
		...
		newChildDescriptors.add
			(createChildParameter
				(TTMCHybridPackage.Literals.PROPERTY_DECLARATION__EXPRESSION,
