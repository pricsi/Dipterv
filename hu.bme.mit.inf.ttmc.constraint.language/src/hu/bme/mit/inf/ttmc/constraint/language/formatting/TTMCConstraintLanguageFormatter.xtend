 ...
 * generated by Xtext
 */
package hu.bme.mit.inf.ttmc.constraint.language.formatting
 ...
 */
public class TTMCConstraintLanguageFormatter extends AbstractDeclarativeFormatter {
	
	@Inject extension TTMCConstraintLanguageGrammarAccess
