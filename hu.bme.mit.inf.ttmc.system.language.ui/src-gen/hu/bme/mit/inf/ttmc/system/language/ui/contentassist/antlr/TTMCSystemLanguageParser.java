 ...
 * generated by Xtext
 */
package hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr;
...
public class TTMCSystemLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr.internal.InternalTTMCSystemLanguageParser createParser() {
		hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr.internal.InternalTTMCSystemLanguageParser result = new hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr.internal.InternalTTMCSystemLanguageParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSystemSpecificationAccess().getAlternatives_4(), "rule__SystemSpecification__Alternatives_4");
					put(grammarAccess.getMultiSystemAccess().getAlternatives(), "rule__MultiSystem__Alternatives");
					put(grammarAccess.getPrimarySystemAccess().getAlternatives(), "rule__PrimarySystem__Alternatives");
					put(grammarAccess.getSystemDefinitionAccess().getAlternatives_2(), "rule__SystemDefinition__Alternatives_2");
					put(grammarAccess.getVariableDeclarationAccess().getAlternatives(), "rule__VariableDeclaration__Alternatives");
					put(grammarAccess.getSystemConstraintDefinitionAccess().getAlternatives(), "rule__SystemConstraintDefinition__Alternatives");
					...
					put(grammarAccess.getSystemSpecificationAccess().getGroup(), "rule__SystemSpecification__Group__0");
					put(grammarAccess.getSystemSpecificationAccess().getGroup_2(), "rule__SystemSpecification__Group_2__0");
					put(grammarAccess.getSystemSpecificationAccess().getGroup_2_1(), "rule__SystemSpecification__Group_2_1__0");
					put(grammarAccess.getSystemSpecificationAccess().getGroup_2_1_1(), "rule__SystemSpecification__Group_2_1_1__0");
					put(grammarAccess.getSystemDeclarationAccess().getGroup(), "rule__SystemDeclaration__Group__0");
					put(grammarAccess.getSystemDeclarationAccess().getGroup_2(), "rule__SystemDeclaration__Group_2__0");
					put(grammarAccess.getSystemDeclarationAccess().getGroup_2_1(), "rule__SystemDeclaration__Group_2_1__0");
					put(grammarAccess.getSystemDeclarationAccess().getGroup_2_1_1(), "rule__SystemDeclaration__Group_2_1_1__0");
					put(grammarAccess.getAsynchronousCompositeSystemAccess().getGroup(), "rule__AsynchronousCompositeSystem__Group__0");
					put(grammarAccess.getAsynchronousCompositeSystemAccess().getGroup_1(), "rule__AsynchronousCompositeSystem__Group_1__0");
					put(grammarAccess.getSynchronousCompositeSystemAccess().getGroup(), "rule__SynchronousCompositeSystem__Group__0");
					put(grammarAccess.getSynchronousCompositeSystemAccess().getGroup_1(), "rule__SynchronousCompositeSystem__Group_1__0");
					put(grammarAccess.getSynchronousMultiSystemAccess().getGroup(), "rule__SynchronousMultiSystem__Group__0");
					put(grammarAccess.getSynchronousMultiSystemAccess().getGroup_4(), "rule__SynchronousMultiSystem__Group_4__0");
					put(grammarAccess.getAsynchronousMultiSystemAccess().getGroup(), "rule__AsynchronousMultiSystem__Group__0");
					put(grammarAccess.getAsynchronousMultiSystemAccess().getGroup_4(), "rule__AsynchronousMultiSystem__Group_4__0");
					put(grammarAccess.getPrimarySystemAccess().getGroup_2(), "rule__PrimarySystem__Group_2__0");
					put(grammarAccess.getSystemReferenceAccess().getGroup(), "rule__SystemReference__Group__0");
					put(grammarAccess.getSystemReferenceAccess().getGroup_2(), "rule__SystemReference__Group_2__0");
					put(grammarAccess.getSystemReferenceAccess().getGroup_2_1(), "rule__SystemReference__Group_2_1__0");
					put(grammarAccess.getSystemReferenceAccess().getGroup_2_1_1(), "rule__SystemReference__Group_2_1_1__0");
					put(grammarAccess.getSystemDefinitionAccess().getGroup(), "rule__SystemDefinition__Group__0");
					put(grammarAccess.getDefinitionDeclarationAccess().getGroup(), "rule__DefinitionDeclaration__Group__0");
					...
					put(grammarAccess.getOutputVariableDeclarationAccess().getGroup(), "rule__OutputVariableDeclaration__Group__0");
					put(grammarAccess.getInvariantConstraintDefinitionAccess().getGroup(), "rule__InvariantConstraintDefinition__Group__0");
					put(grammarAccess.getInitialConstraintDefinitionAccess().getGroup(), "rule__InitialConstraintDefinition__Group__0");
					put(grammarAccess.getTransitionConstraintDefinitionAccess().getGroup(), "rule__TransitionConstraintDefinition__Group__0");
					...
					put(grammarAccess.getSystemSpecificationAccess().getNameAssignment_1(), "rule__SystemSpecification__NameAssignment_1");
					put(grammarAccess.getSystemSpecificationAccess().getParameterDeclarationsAssignment_2_1_0(), "rule__SystemSpecification__ParameterDeclarationsAssignment_2_1_0");
					put(grammarAccess.getSystemSpecificationAccess().getParameterDeclarationsAssignment_2_1_1_1(), "rule__SystemSpecification__ParameterDeclarationsAssignment_2_1_1_1");
					put(grammarAccess.getSystemSpecificationAccess().getTypeDeclarationsAssignment_4_0(), "rule__SystemSpecification__TypeDeclarationsAssignment_4_0");
					put(grammarAccess.getSystemSpecificationAccess().getFunctionDeclarationsAssignment_4_1(), "rule__SystemSpecification__FunctionDeclarationsAssignment_4_1");
					put(grammarAccess.getSystemSpecificationAccess().getConstantDeclarationsAssignment_4_2(), "rule__SystemSpecification__ConstantDeclarationsAssignment_4_2");
					put(grammarAccess.getSystemSpecificationAccess().getBasicConstraintDefinitionsAssignment_4_3(), "rule__SystemSpecification__BasicConstraintDefinitionsAssignment_4_3");
					put(grammarAccess.getSystemSpecificationAccess().getSystemDeclarationsAssignment_4_4(), "rule__SystemSpecification__SystemDeclarationsAssignment_4_4");
					put(grammarAccess.getSystemSpecificationAccess().getPropertyDeclarationsAssignment_4_5(), "rule__SystemSpecification__PropertyDeclarationsAssignment_4_5");
					put(grammarAccess.getSystemDeclarationAccess().getNameAssignment_1(), "rule__SystemDeclaration__NameAssignment_1");
					put(grammarAccess.getSystemDeclarationAccess().getParameterDeclarationsAssignment_2_1_0(), "rule__SystemDeclaration__ParameterDeclarationsAssignment_2_1_0");
					put(grammarAccess.getSystemDeclarationAccess().getParameterDeclarationsAssignment_2_1_1_1(), "rule__SystemDeclaration__ParameterDeclarationsAssignment_2_1_1_1");
					put(grammarAccess.getSystemDeclarationAccess().getSystemAssignment_4(), "rule__SystemDeclaration__SystemAssignment_4");
					put(grammarAccess.getAsynchronousCompositeSystemAccess().getRightSystemAssignment_1_2(), "rule__AsynchronousCompositeSystem__RightSystemAssignment_1_2");
					put(grammarAccess.getSynchronousCompositeSystemAccess().getRightSystemAssignment_1_2(), "rule__SynchronousCompositeSystem__RightSystemAssignment_1_2");
					put(grammarAccess.getSynchronousMultiSystemAccess().getParameterDeclarationsAssignment_3(), "rule__SynchronousMultiSystem__ParameterDeclarationsAssignment_3");
					put(grammarAccess.getSynchronousMultiSystemAccess().getParameterDeclarationsAssignment_4_1(), "rule__SynchronousMultiSystem__ParameterDeclarationsAssignment_4_1");
					put(grammarAccess.getSynchronousMultiSystemAccess().getSystemAssignment_7(), "rule__SynchronousMultiSystem__SystemAssignment_7");
					put(grammarAccess.getAsynchronousMultiSystemAccess().getParameterDeclarationsAssignment_3(), "rule__AsynchronousMultiSystem__ParameterDeclarationsAssignment_3");
					put(grammarAccess.getAsynchronousMultiSystemAccess().getParameterDeclarationsAssignment_4_1(), "rule__AsynchronousMultiSystem__ParameterDeclarationsAssignment_4_1");
					put(grammarAccess.getAsynchronousMultiSystemAccess().getSystemAssignment_7(), "rule__AsynchronousMultiSystem__SystemAssignment_7");
					put(grammarAccess.getSystemReferenceAccess().getReferenceAssignment_1(), "rule__SystemReference__ReferenceAssignment_1");
					put(grammarAccess.getSystemReferenceAccess().getParametersAssignment_2_1_0(), "rule__SystemReference__ParametersAssignment_2_1_0");
					put(grammarAccess.getSystemReferenceAccess().getParametersAssignment_2_1_1_1(), "rule__SystemReference__ParametersAssignment_2_1_1_1");
					put(grammarAccess.getSystemDefinitionAccess().getVariableDeclarationsAssignment_2_0(), "rule__SystemDefinition__VariableDeclarationsAssignment_2_0");
					put(grammarAccess.getSystemDefinitionAccess().getDefinitionDeclarationsAssignment_2_1(), "rule__SystemDefinition__DefinitionDeclarationsAssignment_2_1");
					put(grammarAccess.getSystemDefinitionAccess().getSystemConstraintDefinitionsAssignment_2_2(), "rule__SystemDefinition__SystemConstraintDefinitionsAssignment_2_2");
					put(grammarAccess.getDefinitionDeclarationAccess().getNameAssignment_1(), "rule__DefinitionDeclaration__NameAssignment_1");
					put(grammarAccess.getDefinitionDeclarationAccess().getTypeAssignment_3(), "rule__DefinitionDeclaration__TypeAssignment_3");
					put(grammarAccess.getDefinitionDeclarationAccess().getExpressionAssignment_5(), "rule__DefinitionDeclaration__ExpressionAssignment_5");
					...
					put(grammarAccess.getGlobalVariableDeclarationAccess().getNameAssignment_2(), "rule__GlobalVariableDeclaration__NameAssignment_2");
					put(grammarAccess.getGlobalVariableDeclarationAccess().getTypeAssignment_4(), "rule__GlobalVariableDeclaration__TypeAssignment_4");
					...
					put(grammarAccess.getOutputVariableDeclarationAccess().getNameAssignment_2(), "rule__OutputVariableDeclaration__NameAssignment_2");
					put(grammarAccess.getOutputVariableDeclarationAccess().getTypeAssignment_4(), "rule__OutputVariableDeclaration__TypeAssignment_4");
					put(grammarAccess.getInvariantConstraintDefinitionAccess().getExpressionAssignment_1(), "rule__InvariantConstraintDefinition__ExpressionAssignment_1");
					put(grammarAccess.getInitialConstraintDefinitionAccess().getExpressionAssignment_1(), "rule__InitialConstraintDefinition__ExpressionAssignment_1");
					put(grammarAccess.getTransitionConstraintDefinitionAccess().getExpressionAssignment_1(), "rule__TransitionConstraintDefinition__ExpressionAssignment_1");
					put(grammarAccess.getPropertyDeclarationAccess().getNameAssignment_1(), "rule__PropertyDeclaration__NameAssignment_1");
					put(grammarAccess.getPropertyDeclarationAccess().getSystemAssignment_3(), "rule__PropertyDeclaration__SystemAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr.internal.InternalTTMCSystemLanguageParser typedParser = (hu.bme.mit.inf.ttmc.system.language.ui.contentassist.antlr.internal.InternalTTMCSystemLanguageParser) parser;
			typedParser.entryRuleSystemSpecification();
