...
entryRuleSystemSpecification returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSystemSpecificationRule()); }
	 iv_ruleSystemSpecification=ruleSystemSpecification 
	 { $current=$iv_ruleSystemSpecification.current; } 
	 EOF 
;

// Rule SystemSpecification
ruleSystemSpecification returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
...
ruleSystem returns [EObject current=null] 
    ...
    { 
        $current = $this_AsynchronousCompositeSystem_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleAsynchronousCompositeSystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAsynchronousCompositeSystemRule()); }
	 ...
	 { $current=$iv_ruleAsynchronousCompositeSystem.current; } 
	 EOF 
;

// Rule AsynchronousCompositeSystem
ruleAsynchronousCompositeSystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_SynchronousCompositeSystem_0.current; 
        afterParserOrEnumRuleCall();
    }
((
    {
...
entryRuleSynchronousCompositeSystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSynchronousCompositeSystemRule()); }
	 ...
	 { $current=$iv_ruleSynchronousCompositeSystem.current; } 
	 EOF 
;

// Rule SynchronousCompositeSystem
ruleSynchronousCompositeSystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_MultiSystem_0.current; 
        afterParserOrEnumRuleCall();
    }
((
    {
...
entryRuleMultiSystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMultiSystemRule()); }
	 iv_ruleMultiSystem=ruleMultiSystem 
	 { $current=$iv_ruleMultiSystem.current; } 
	 EOF 
;

// Rule MultiSystem
ruleMultiSystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_SynchronousMultiSystem_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_AsynchronousMultiSystem_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_PrimarySystem_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleSynchronousMultiSystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSynchronousMultiSystemRule()); }
	 iv_ruleSynchronousMultiSystem=ruleSynchronousMultiSystem 
	 { $current=$iv_ruleSynchronousMultiSystem.current; } 
	 EOF 
;

// Rule SynchronousMultiSystem
ruleSynchronousMultiSystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleAsynchronousMultiSystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAsynchronousMultiSystemRule()); }
	 iv_ruleAsynchronousMultiSystem=ruleAsynchronousMultiSystem 
	 { $current=$iv_ruleAsynchronousMultiSystem.current; } 
	 EOF 
;

// Rule AsynchronousMultiSystem
ruleAsynchronousMultiSystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRulePrimarySystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPrimarySystemRule()); }
	 iv_rulePrimarySystem=rulePrimarySystem 
	 { $current=$iv_rulePrimarySystem.current; } 
	 EOF 
;

// Rule PrimarySystem
rulePrimarySystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRuleDefinitionDeclaration returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDefinitionDeclarationRule()); }
	 iv_ruleDefinitionDeclaration=ruleDefinitionDeclaration 
	 { $current=$iv_ruleDefinitionDeclaration.current; } 
	 EOF 
;

// Rule DefinitionDeclaration
ruleDefinitionDeclaration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
...
(
    ...
    { 
        $current = $this_GlobalVariableDeclaration_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_InputVariableDeclaration_2.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_OutputVariableDeclaration_3.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleOutputVariableDeclaration returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getOutputVariableDeclarationRule()); }
	 ...
	 { $current=$iv_ruleOutputVariableDeclaration.current; } 
	 EOF 
;

// Rule OutputVariableDeclaration
ruleOutputVariableDeclaration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='output' 
...
entryRuleSystemConstraintDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSystemConstraintDefinitionRule()); }
	 ...
	 { $current=$iv_ruleSystemConstraintDefinition.current; } 
	 EOF 
;

// Rule SystemConstraintDefinition
ruleSystemConstraintDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_InvariantConstraintDefinition_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_InitialConstraintDefinition_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_TransitionConstraintDefinition_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleInvariantConstraintDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInvariantConstraintDefinitionRule()); }
	 ...
	 { $current=$iv_ruleInvariantConstraintDefinition.current; } 
	 EOF 
;

// Rule InvariantConstraintDefinition
ruleInvariantConstraintDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='invariant' 
...
entryRuleInitialConstraintDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInitialConstraintDefinitionRule()); }
	 ...
	 { $current=$iv_ruleInitialConstraintDefinition.current; } 
	 EOF 
;

// Rule InitialConstraintDefinition
ruleInitialConstraintDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='initial' 
...
entryRuleTransitionConstraintDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTransitionConstraintDefinitionRule()); }
	 ...
	 { $current=$iv_ruleTransitionConstraintDefinition.current; } 
	 EOF 
;

// Rule TransitionConstraintDefinition
ruleTransitionConstraintDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
